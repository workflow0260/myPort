...
export const ArchitectureFlowSection: React.FC = () => {
  ...
  return (
    <section id="engineering" className="w-full py-24 px-6 sm:px-12 border-b border-[rgba(17,17,16,0.08)] bg-[var(--bg-background)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {engineeringNotebook.map((item, idx) => (
            <Reveal key={idx} delay={0.1 * (idx + 1)}>
              <div className="card-engineered rounded-2xl p-7 sm:p-8 space-y-5 h-full group hover:border-[#173753]/30 transition-all">
                {/* Header */}
